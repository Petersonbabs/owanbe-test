...
const StatisticsBar = () => {
  const gridRef = useStaggerAnimation(">div", { animation: "slideUp", duration: 0.6, stagger: 0.1 });

  return (
    <section className="bg-[#D32E12] py-8 md:py-12 px-[5%]">
      <div className=" mx-auto">
        <div ref={gridRef as React.RefObject<HTMLDivElement>} className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
